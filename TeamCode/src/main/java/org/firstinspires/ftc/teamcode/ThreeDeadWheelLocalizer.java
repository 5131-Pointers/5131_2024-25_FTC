...
public final class ThreeDeadWheelLocalizer implements Localizer {
    public static class Params {
        public double par0YTicks = -2424.8533667577426; // y position of the first parallel encoder (in tick units)
        public double par1YTicks = 2280.13373674635; // y position of the second parallel encoder (in tick units)
        public double perpXTicks = 1767.2413794389709; // x position of the perpendicular encoder (in tick units)
    }

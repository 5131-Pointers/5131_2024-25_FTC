...
public final class ThreeDeadWheelLocalizer implements Localizer {
    public static class Params {
        public double par0YTicks = -2368.7776279424143; // y position of the first parallel encoder (in tick units)
        public double par1YTicks = 2415.1101607876326; // y position of the second parallel encoder (in tick units)
        public double perpXTicks = 2368.7776279424143; // x position of the perpendicular encoder (in tick units)
    }
